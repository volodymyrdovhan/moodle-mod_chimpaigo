...
/**
 * Defines backup_chimpaigo_activity_task class
 *
...
require_once($CFG->dirroot . '/mod/chimpaigo/backup/moodle2/backup_chimpaigo_stepslib.php');
...
class backup_chimpaigo_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the chimpaigo.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_chimpaigo_activity_structure_step('chimpaigo_structure', 'chimpaigo.xml'));
    }
