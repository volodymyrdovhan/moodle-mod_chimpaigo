...
/**
 * Strings for component 'mod_chimpaigo', language 'en'.
 *
...
$string['chimpaigo:addinstance'] = 'Add a new chimpAIgo activity';
$string['chimpaigo:view'] = 'View chimpAIgo activity';
$string['baseurl_setting_label'] = 'Base URL';
$string['baseurl_setting_description'] = 'URL of the chimpAIgo! LTI 1.3 tool.';
